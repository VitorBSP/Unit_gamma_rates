...
```{julia}
plot(x,  probs1, legend = false, color = "#000000")
xlabel!("Suporte da Gamma Unitária")
ylabel!("Densidade")
```
...
```{julia}
plot(x,  probs2, legend = false, color = "#000000")
xlabel!("Suporte da Gamma Unitária")
ylabel!("Densidade")
```
:::
...
```{julia}
#| echo: false
plot(x, integral1, legend = false, color = "#000000")
xlabel!(L"GU($\alpha$ = 0.5, $\tau$ = 0.5)")
...
```{julia}
plot(x,  integral2, legend = false, color = "#000000")
xlabel!(L"GU($\alpha$ = 0.73, $\tau$ = 0.5)")
ylabel!("Probabilidade")
```
