...
integral1 = quadgk.(pgu_int, 0, x, rtol=1e-3);

alpha = 0.73;

integral2 = quadgk.(pgu_int, 0, x, rtol=1e-3);

integral1 = map(x->x[1], integral1);
integral2 = getindex.(integral2, 1);

p1 = plot(x, integral1, legend = false, color = :black);
p1 = xlabel!(L"GU($\alpha$ = 0.5, $\tau$ = 0.5)");
p1 = ylabel!("Probabilidade");


p2 = plot(x,  integral2, legend = false, color = :black);
p2 = xlabel!(L"GU($\alpha$ = 0.73, $\tau$ = 0.5)");
p2 = ylabel!("Probabilidade");
```
